    ...
    <header id="header" class="px-5 bg-white shadow-md">
        <div class="flex gap-4 justify-between items-center">
            ...
            <div class="flex w-full">
                <button data-dropdown-toggle="menu_search" data-dropdown-placement="bottom-end" class="flex gap-2 items-center border border-gray-300 rounded-l p-1 text-amber-700 px-2">
            ...
            <div id="menu_search" class="z-[100] hidden bg-slate-900 rounded-lg shadow w-max divide-y divide-slate-800 top-20">
                <ul class="py-2 text-sm text-gray-700">
                    <li data-dropdown-toggle="categoria_search" data-dropdown-placement="right-end">
                        <button class="block px-4 py-2 hover:bg-slate-800 text-white w-full text-start">Categorias</button>
                        <div id="categoria_search" class="z-[100] hidden bg-slate-900 rounded-lg shadow w-max divide-y divide-slate-800 top-20">
                            <ul class="py-2 text-sm text-gray-700">
                                <?php
                                    foreach ((CategoriaSoftware::find()->all()) as $categoria){
                                        echo '
                                            <li data-dropdown-toggle="categoria_search" data-dropdown-placement="right-end">
                                                <a href="#" class="block px-4 py-2 hover:bg-slate-800 text-white">'.$categoria['nombre'].'</a>
                                            </li>
                                        ';
                                    }
                                ?>
                    ...
                    <li data-dropdown-toggle="licencias_search" data-dropdown-placement="right">
                        <button class="block px-4 py-2 hover:bg-slate-800 text-white w-full text-start">Tipos de Licencias</button>
                        <div id="licencias_search" class="z-[100] hidden bg-slate-900 rounded-lg shadow w-max divide-y divide-slate-800 top-20">
                            <ul class="py-2 text-sm text-gray-700">
                                <?php
                                    foreach ((LicenciaSoftware::find()->all()) as $licencia){
                                        echo '
                                                <li>
                                                    <a href="#" class="block px-4 py-2 hover:bg-slate-800 text-white">'.$licencia['nombre'].'</a>
                                                </li>
                                            ';
                                    }
                                ?>
            ...
            <?php if(!Yii::$app->user->isGuest) : ?>
                <div class="flex gap-3 items-center">
                    ...
                    <div id="menu_toggle" class="z-[100] hidden bg-slate-900 rounded-lg shadow w-max divide-y divide-slate-800 top-20">
                            ...
                            <ul class="py-2 text-sm text-gray-700">
                                ...
                                <li>
                                    ...
                                    <div id="forms_down" class="z-10 hidden bg-slate-900 divide-y divide-gray-100 rounded-lg shadow w-max">
                                        <ul class="py-2 text-sm text-gray-700">
                                            <li>
                                                <a href="<?= Yii::getAlias('@web/administrador/software/create')?>" class="block px-4 py-2 hover:bg-slate-800 text-white">Registro de software</a>
                                            </li>
                                            <li>
                                                <a href="<?= Yii::getAlias('@web/administrador/carousel')?>" class="block px-4 py-2 hover:bg-slate-800 text-white">Registro de carousel</a>
                                            </li>
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-slate-800 text-white hidden">Registro de licencias</a>
                                            </li>
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-slate-800 text-white hidden">Registro de categoria</a>
                                            </li>
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-slate-800 text-white hidden">Registro de usuarios</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                        ...
                        <?php if (key(Role::getUserRoles(Yii::$app->user->id)) === 'Usuario') : ?>
                            <ul class="py-2 text-sm text-gray-700">
                                <li>
                                    <a href="<?= Yii::getAlias('/usuario')?>" class="block px-4 py-2 hover:bg-slate-800 text-white">Dashboard</a>
                                </li>
                                <li>
                                    <a href="<?= Yii::getAlias('/usuario/mis-favoritos')?>" class="block px-4 py-2 hover:bg-slate-800 text-white">Favoritos</a>
                                </li>
                            </ul>
                        <?php endif;?>
